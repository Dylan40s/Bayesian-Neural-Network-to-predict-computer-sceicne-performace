...
tf.flags.DEFINE_integer("T", default=1244, help="Number of total")
...
# 5 layer network, 7 input nodes -> h1 -> h2 -> h3 -> 4 output nodes
def neural_network(X,W_0,W_1,W_2,W_3,b_0,b_1,b_2,b_3,N):
	...
	h3= tf.nn.tanh(tf.matmul(h2, W_2) + b_2)
...
# creates an array to pass into the save function
# This array holds the parameters for the function to run through all permutation
def loadParams():
	returned = []
	hidden = [10,20,50]
	iter1 = [1000,10000]
